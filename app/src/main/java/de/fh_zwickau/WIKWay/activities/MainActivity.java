...
import de.fh_zwickau.WIKWay.Data.DBHelper;
import de.fh_zwickau.WIKWay.HttpHandler;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     public void saveFavorite(){
         btn = (Button) findViewById(R.id.btn_favorite);
         btn.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 AdapterView parent = (AdapterView) v.getParent();
                 ListView listView = (ListView) parent.getParent();
                 Job itemChosen = (Job) parent.getItemAtPosition(global_position);
